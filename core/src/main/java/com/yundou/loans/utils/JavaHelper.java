...
//    private static Log log = LogFactory.getLog(Lang.class);
    ...
    public static Class<?> loadClass(String className) {
        if ((className == null) || className.trim().length() == 0) {
            Log.e(JavaHelper.class.getName(), "loadClass error, className is null. ");
            return null;
        }
        try {
...
//    }
    ...
    public static String hexToStr(String hexStr) {
        try {
            ...
            Log.e(JavaHelper.class.toString(), e.getMessage() + ": " + hexStr, e);
            return "";
        }
    }
    ...
    public static String formatNumber(String inputNumber, String pattern) {
        try {
            ...
            Log.e(JavaHelper.class.toString(), "formatNumber error:" + inputNumber + " pattern:" + pattern, e);
            return inputNumber;
        }
    }
