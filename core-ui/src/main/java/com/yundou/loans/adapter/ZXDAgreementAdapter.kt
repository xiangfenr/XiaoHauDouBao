...
class ZXDAgreementAdapter :
    BaseQuickAdapter<ZxdNewAgreeBean, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(R.layout.asr_agreement_adapter_item) {
     ...
     */
    override fun setList(list: Collection<ZxdNewAgreeBean>?) {
        super.setList(list)
