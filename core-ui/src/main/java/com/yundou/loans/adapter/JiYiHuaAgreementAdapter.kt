...
import com.yundou.loans.entity.JiYiHuaAgreement
...
class JiYiHuaAgreementAdapter :
    BaseQuickAdapter<JiYiHuaAgreement, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
     ...
     */
    override fun setList(list: Collection<JiYiHuaAgreement>?) {
        super.setList(list)
