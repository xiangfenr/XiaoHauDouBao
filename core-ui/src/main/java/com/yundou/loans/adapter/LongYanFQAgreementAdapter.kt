...
import com.yundou.loans.entity.LongYanAgreeMentBean
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat

class LongYanFQAgreementAdapter :
    BaseQuickAdapter<LongYanAgreeMentBean, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
     ...
     */
    override fun setList(list: Collection<LongYanAgreeMentBean>?) {
        super.setList(list)
