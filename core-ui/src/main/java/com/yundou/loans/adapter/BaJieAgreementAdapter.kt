...
import com.yundou.loans.entity.BaJieAgreement
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat
import kotlin.collections.set

class BaJieAgreementAdapter :
    BaseQuickAdapter<BaJieAgreement, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
     ...
     */
    override fun setList(list: Collection<BaJieAgreement>?) {
        super.setList(list)
