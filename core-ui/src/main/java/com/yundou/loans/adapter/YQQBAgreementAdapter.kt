...
import com.yundou.loans.entity.ProtocolListData
import com.yundou.loans.entity.YqqbProtocol
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat


class YQQBAgreementAdapter :
    BaseQuickAdapter<YqqbProtocol, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(R.layout.asr_agreement_adapter_item) {
...
//            }
     ...
     */
    override fun setList(list: Collection<YqqbProtocol>?) {
        super.setList(list)
