...
import com.yundou.loans.entity.qiDaiAgreement
...
class QiDaiAgreementAdapter :
    BaseQuickAdapter<qiDaiAgreement, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(R.layout.asr_agreement_adapter_item) {
...
//            }
     ...
     */
    override fun setList(list: Collection<qiDaiAgreement>?) {
        super.setList(list)
