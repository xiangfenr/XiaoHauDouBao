...
import com.yundou.loans.entity.WeiYinProtocol
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat

class WeiYinAgreementAdapter :
    BaseQuickAdapter<WeiYinProtocol, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
    ...
    override fun convert(
        ...
        holder.dataBinding?.let {
            ...
            it.root.clickNoRepeat {
                ...
                intent.putExtra("webUrl", item.protocolValue)
                intent.putExtra("webName", item.protocolName)
     ...
     */
    override fun setList(list: Collection<WeiYinProtocol>?) {
        super.setList(list)
