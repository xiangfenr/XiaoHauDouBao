...
import com.yundou.loans.entity.JiYongAgreements
...
class JYQBAgreementAdapter :
    BaseQuickAdapter<JiYongAgreements, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
     ...
     */
    override fun setList(list: Collection<JiYongAgreements>?) {
        super.setList(list)
