...
import com.yundou.loans.entity.Platform
import com.yundou.loans.entity.PlatformProtocolDetail
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat

class YXHPlatformsAgreementAdapter :
    BaseQuickAdapter<PlatformProtocolDetail, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(R.layout.asr_agreement_adapter_item) {
     ...
     */
    override fun setList(list: Collection<PlatformProtocolDetail>?) {
        super.setList(list)
