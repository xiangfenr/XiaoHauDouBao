...
import com.yundou.loans.entity.JiDaiProtocolItem
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat

class JiDaiAgreementAdapter :
    BaseQuickAdapter<JiDaiProtocolItem, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
     ...
     */
    override fun setList(list: Collection<JiDaiProtocolItem>?) {
        super.setList(list)
