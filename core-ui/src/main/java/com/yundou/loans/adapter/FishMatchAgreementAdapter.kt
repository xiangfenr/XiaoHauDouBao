...
import com.yundou.loans.entity.FishMatchProtocol
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat
import kotlin.collections.set

class FishMatchAgreementAdapter :
    BaseQuickAdapter<FishMatchProtocol, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
     ...
     */
    override fun setList(list: Collection<FishMatchProtocol>?) {
        super.setList(list)
