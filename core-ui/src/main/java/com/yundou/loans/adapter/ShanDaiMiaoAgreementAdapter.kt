...
import com.yundou.loans.entity.ShanDaiMiaoAgreement
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat
import kotlin.collections.set

class ShanDaiMiaoAgreementAdapter :
    BaseQuickAdapter<ShanDaiMiaoAgreement, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
    ...
    override fun convert(
        ...
        item: ShanDaiMiaoAgreement,
    ) {

        holder.dataBinding?.let {
            it.xieyiTv.text = item.name
            ...
            it.root.clickNoRepeat {
                ...
                intent.putExtra("webName", item.name)
     ...
     */
    override fun setList(list: Collection<ShanDaiMiaoAgreement>?) {
        super.setList(list)
