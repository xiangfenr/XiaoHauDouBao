...
class SRAgreementAdapter :
    BaseQuickAdapter<ProtocolListData, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(R.layout.asr_agreement_adapter_item) {
     ...
     */
    override fun setList(list: Collection<ProtocolListData>?) {
        super.setList(list)
