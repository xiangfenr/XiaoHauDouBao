...
import com.yundou.loans.entity.TxfqApplyAgreementData
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat

class TXFQAgreementAdapter :
    BaseQuickAdapter<TxfqApplyAgreementData, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
        R.layout.asr_agreement_adapter_item) {
    ...
    override fun convert(
        ...
        item: TxfqApplyAgreementData,
    ) {



        holder.dataBinding?.let {
            it.xieyiTv.text = item.contractName
            ...
            it.root.clickNoRepeat {
                ...
                intent.putExtra("webUrl", item.contractContent)
                intent.putExtra("webName", item.contractName)
     ...
     */
    override fun setList(list: Collection<TxfqApplyAgreementData>?) {
        super.setList(list)
