...
import com.yundou.loans.entity.ProtocolData
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat

class YXHAgreementAdapter :
    BaseQuickAdapter<ProtocolData, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(R.layout.asr_agreement_adapter_item) {
     ...
     */
    override fun setList(list: Collection<ProtocolData>?) {
        super.setList(list)
