...
import com.yundou.loans.entity.XiaoFuAgreement
import com.yundou.loans.ui.CommonWebViewActivity
import com.yundou.loans.widget.clickNoRepeat

class XiaoFuJKAgreementAdapter :
    BaseQuickAdapter<XiaoFuAgreement, BaseDataBindingHolder<AsrAgreementAdapterItemBinding>>(
    ...
    override fun convert(
        ...
        item: XiaoFuAgreement,
    ) {

        holder.dataBinding?.let {
            it.xieyiTv.text = item.title
            ...
            it.root.clickNoRepeat {
                ...
                intent.putExtra("webUrl", item.uri)
                intent.putExtra("webName", item.title)
     ...
     */
    override fun setList(list: Collection<XiaoFuAgreement>?) {
        super.setList(list)
