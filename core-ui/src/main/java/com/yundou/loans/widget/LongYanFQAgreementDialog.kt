...
import com.yundou.loans.adapter.LongYanFQAgreementAdapter
import com.yundou.loans.coreui.databinding.AsrAgreementDialogBinding
import com.yundou.loans.entity.LongYanFormResultBean
 ...
 * 时间: 2025/12/3
 * 类名: ACTIVITY
 * 简述: 龙炎分期 - Agreement Dialog
 *
 */
class LongYanFQAgreementDialog(private var context: Context) : BottomPopupView(context) {

    private lateinit var mBinding: AsrAgreementDialogBinding
    private var agreementData: LongYanFormResultBean? = null

    private val adapter by lazy { LongYanFQAgreementAdapter() }
    ...
    override fun onCreate() {
        ...
        agreementData?.let {
            ...
            adapter.setList(it.product_agreement)
        }
    ...
    fun setAgreementtData(data: LongYanFormResultBean) {
