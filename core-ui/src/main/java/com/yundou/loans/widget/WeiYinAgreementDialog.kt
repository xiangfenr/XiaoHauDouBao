...
import com.yundou.loans.adapter.WeiYinAgreementAdapter
import com.yundou.loans.coreui.databinding.AsrAgreementDialogBinding
import com.yundou.loans.entity.WeiYinProductInfo
 ...
 *
 */
class WeiYinAgreementDialog(private var context: Context) : BottomPopupView(context) {

    private lateinit var mBinding: AsrAgreementDialogBinding
    private var agreementData: WeiYinProductInfo? = null

    private val adapter by lazy { WeiYinAgreementAdapter() }
    ...
    fun setAgreementtData(data: WeiYinProductInfo) {
