...
import com.yundou.loans.adapter.JiDaiAgreementAdapter
import com.yundou.loans.coreui.databinding.AsrAgreementDialogBinding
import com.yundou.loans.entity.JiDaiProductInfo
 ...
 * 时间: 2025/12/3
 * 类名: ACTIVITY
 * 简述: 吉贷Agreement Dialog
 *
 */
class JiDaiAgreementDialog(private var context: Context) : BottomPopupView(context) {

    private lateinit var mBinding: AsrAgreementDialogBinding
    private var agreementData: JiDaiProductInfo? = null

    private val adapter by lazy { JiDaiAgreementAdapter() }
    ...
    fun setAgreementtData(data: JiDaiProductInfo) {
